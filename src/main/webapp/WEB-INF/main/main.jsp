 ...
 <div class="swiper-container new_shop">
  ...
  <c:forEach var="sprVo" items="${sprVos}">
       ...
       <div class="swiper-slide">
    	<a href="ShowStoreDetail.st?storeId=${sprVo.storeId}">
    	    <div><img src="${ctp}/images/photoView/${sprVo.storeMainPhoto}" width=100%></div>
    		<p>${sprVo.storeName}</p>
    			
    			<div class="review_and_heart">
    			   <div class="inner">
    			   	 	<img alt="리뷰아이콘" src="${ctp}/images/ico_review.png">
    			   	 	<div class="review_cnt" style="margin-left:5px">${sprVo.reviewCnt}</div>
    			   </div>
    			   <div class="inner" style="margin-left:10px">
    			   		<img alt="하트아이콘" src="${ctp}/images/ico_heart_fill.png">
    			   	 
    			   	 	<div class="heart_cnt" style="margin-left:5px">${sprVo.heartCnt}</div>
    			   </div>
    			</div>
    			...
    			<div class="dist_and_price">
    				...
    				<div class="price">
    					<p class="original" style="text-decoration:line-through">${sprVo.originalPrice}<em class="unit_ko">원</em></p>
    					<p class="dc" style="margin-top:-15px"><span style="color:red;">${sprVo.discountRate}%</span>
    					                                                <!-- 세자리마다 쉼표를 찍는다. -->
    					<strong><fmt:formatNumber type="number" maxFractionDigits="3" value="${sprVo.discountedPrice}" /></strong>
...
<div class="register_ad" style="margin-top:10px;" onclick="location.href='#'">
	<div class="left_group"> <!-- flex 레이아웃 -->
		...
		<div class="text_group" style="margin-left:10px">
			<p style="margin-top:10px;">마캉스가 처음이신가요?</p>
