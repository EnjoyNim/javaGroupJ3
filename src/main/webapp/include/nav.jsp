...
<!--   <a class="navbar-brand" href="http://192.168.50.64:9090/javaGroup">Home</a> 일단은 주석처리-->
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <ul class="navbar-nav">
    	<li class="nav-item">
           <!-- 여기서 서블릿으로 먼저 보내고 그 서블릿에서 guestList.jsp 로 연결해준다 -->
           <!-- 확장자 패턴은 앞에 주소가 필요없다. 확장자가 붙은 이름만 적어주면 된다. -->
      	...
      	<li class="nav-item">
        	<div class="dropdown mr-2">
    			...
    			<div class="dropdown-menu">
			      	...
			      	<a class="dropdown-item" href="${ctp}/study2/database/DbList">데이터베이스 연습</a>
        	...
        	<div class="dropdown">
    			...
    			<div class="dropdown-menu">
			      	...
			      	<c:if test="${sLevel > 1 || sLevel == 0 }">
			      		...
			      		<!-- 관리자 즉, 0레벨만 보이도록 -->
			      	<c:if test="${sLevel eq 0}"> <a class="dropdown-item" href="AdminMain.ad">관리자메뉴</a> </c:if>
    			</div>
  			</div>
      	</li>
